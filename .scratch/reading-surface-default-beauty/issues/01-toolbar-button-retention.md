...
- [x] Primary visible control count ≤14 without wrap-shelf on typical Studio width
- [x] Single theme entry on primary (no dual `editor-theme` + `editor-theme-toggle`)
- [x] `upload` absent from primary bar; still reachable via settings/more
- [x] Right-anchored save / edit-in-vscode / theme / settings retained
- [x] No Welcome / second preview / new chrome family
- [x] Light smoke on markdownViewer; build green; unit where toolbar composition is pure
...
- Forge 2026-09-21 (SGT): implemented; commit `8350e29` (wave ADR 0016). Build + unit green.
