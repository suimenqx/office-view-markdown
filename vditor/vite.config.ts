...
function copyStaticResources(): Plugin {
  return {
    name: "copy-static-resources",
    closeBundle() {
      cpSync(resolve(__dirname, "src/css"), resolve(__dirname, "dist/css"), { recursive: true });
      cpSync(resolve(__dirname, "src/js"), resolve(__dirname, "dist/js"), { recursive: true });
    },
  };
}
