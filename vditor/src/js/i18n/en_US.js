window.VditorI18n = {
  ...
  'actionableImageLoadFailedBody': 'Check the image path and try again.',
  'actionableMermaidRenderFailed': 'Mermaid render failed',
  'actionableMermaidRenderFailedBody': 'Check the diagram syntax and try again.',
  'actionablePlantumlRenderFailed': 'PlantUML render failed',
  'actionablePlantumlRenderFailedBody': 'Check the diagram syntax and try again.',
  'actionablePlantumlUnconfigured': 'PlantUML Server is not configured',
  'actionablePlantumlUnconfiguredBody': 'Diagram source is not sent anywhere until you set a PlantUML Server Base URL.',
